...
function buildRankSummarySec() {
	...
	sumSecDiv.appendChild(createHeader('Ranktest Summary'));
...
function buildContPieChartLegend() {
	...
	table.appendChild(addLegendRow('comp','Compulsory Tests'));
	table.appendChild(addLegendRow('cont','Contributing Tests'));
	table.appendChild(addLegendRow('noncont','Non-Contributing Tests'));
	return table;
}
function buildCovChartSec() {
	...
	secDiv.id = 'covSecDiv';
	verAxisCell.innerHTML = 'Total Coverage';
	verAxisCell.className = 'verAxisTd';
	horAxisCell.innerHTML = 'Number of Tests';
